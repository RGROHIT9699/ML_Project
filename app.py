...
st.markdown(
    "<h1 style='text-align: center; color: #4A90E2; background-color: #000000;'>Diabetes Prediction App</h1>",
    unsafe_allow_html=True
)
st.markdown(
    "<p style='text-align: center; color: #333333;'>This app predicts whether a patient is diabetic based on their health data.</p>",
    unsafe_allow_html=True
)
st.markdown("---")
...
st.markdown(
    f"<h2 style='text-align: center; color: {'#4CAF50' if result[0] == 0 else '#FF4136'}; background-color: #F0F8FF;'>{output}</h2>",
    unsafe_allow_html=True
)
